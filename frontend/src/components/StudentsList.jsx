                                ...
                                <tr key={student.id}>
                                    ...
                                    <td>
                                        <div style={{display: "flex", justifyContent: "space-around"}}>
                                            <div className="btn btn-info" onClick={() => this.updateStudent(student.id)}
                                                 style={{marginRight: "10px"}}><FaUserEdit/></div>
                                            <div className="btn btn-danger"
                                                 onClick={() => this.deleteStudent(student.id)}
                                                 style={{marginRight: "10px"}}><RiDeleteBin5Line/></div>
                                            <div className="btn btn-info"
                                                 onClick={() => this.studentDetails(student.id)}>Details
                                            </div>
