                        ...
                        <div className="card col-md-6 offset-md-3">
                            ...
                            <div className="card-body">
                                <form>
                                    <div className="form-group">
                                        ...
                                        <div className="input-group mb-3">
                                            <select className="custom-select" id="inputGroupSelect02"
                                                ...
                                                <option value="Web Development with Java" name="course">Web Development
                                                    with Java
                                                </option>
                                                <option value="Web Development with Javascript" name="course">Web
                                                    Development with Javascript
                                                </option>
                                                <option value="Data Science and Machine Learning" name="course">Data
                                        ...
                                        <div className="input-group mb-3">
                                            <select className="custom-select" id="inputGroupSelect02"
                                                    onChange={this.handleCityOption}>
                                                <option>Choose...</option>
                                    ...
                                    <button type="button" className="btn btn-success" style={{marginRight: "20px"}}
                                            onClick={this.saveOrUpdate}> Save
                                    </button>
                                    <button type="button" className="btn btn-danger" onClick={this.cancelAdd}>Cancel
                                    </button>
                                </form>
                            </div>
                        </div>
